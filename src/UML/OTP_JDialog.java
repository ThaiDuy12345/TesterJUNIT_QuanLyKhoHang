 ...
 * @author hp
 */
public class OTP_JDialog extends javax.swing.JDialog {

    TaiKhoanDAO dao = new TaiKhoanDAO();
    String sdt, tenDnn, tenNd;
    public static final String ACCOUNT_SID = "AC47dce0186601f123a33b635f36a2f5b1";
    public static final String AUTH_TOKEN = "be1c099bd018be797ef645710c72aa45";

    public OTP_JDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        kGradientPanel2.setkStartColor(new java.awt.Color(153, 255, 102));
        kGradientPanel2.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 16)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(0, 102, 102));
        jLabel2.setText("Nhập vào số điện thoại của bạn");
        ...
        kGradientPanel2.add(btnTim, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 260, 160, 40));
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icon/about.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OTP_JDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                OTP_JDialog dialog = new OTP_JDialog(new javax.swing.JFrame(), true);
    ...
    void find() {
        ...
        Thread thread4 = new Thread() {
            ...
            public void run() {
                ...
                if (kt == false) {
                    ld.dispose();
                    DialogHelper.alert(null, "Số điện thoại bạn vừa nhập không tồn tại trong hệ thống !");
                }
            }
        };thread4.start();
    }
    ...
    boolean checkFrom() {
        if (ValidateNull(txtTimKiem) && txtTimKiem.getText().trim().isEmpty()) {
            ...
            lblLoiThongTin.setText("Nhập vào số điện thoại của bạn!");
            return false;
        }
        lblLoiThongTin.setText("");
        return true;
    }
        ...
        Thread thread2 = new Thread() {
            ...
            public void run() {
                ...
                Message message = Message.creator(
                        new com.twilio.type.PhoneNumber("+84" + sdt.substring(1, 10)),
                        "MG29161269d563651c42c14969540b015b",
                        "Mã xác thực của bạn là " + randomInt)
                        .create();
                ld.dispose();
                JOptionPane.showMessageDialog(rootPane, "Chúng tôi đã gửi một tin nhắn cho bạn để xác thực tài khoản vui lòng kiểm tra lại điện thoại của bạn!");
